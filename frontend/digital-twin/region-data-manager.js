(() => {
  ...
  const TYPES={
    tissue:{title:'Tkanka',empty:'Brak danych tkankowych / WSI jawnie przypisanych do tego regionu.'},
    cellular:{title:'Komórkowe',empty:'Dane komórkowe wymagają jawnie przypisanych danych mikroskopowych.'},
    molecular:{title:'Molekularne',empty:'Brak pomiarów molekularnych jawnie przypisanych do tego regionu.'}
  };
  ...
  const style=document.createElement('style'); style.textContent=`
    ...
    .ri-data-dialog{width:min(470px,calc(100vw - 28px));border:1px solid #d5dde2;border-radius:12px;padding:0;box-shadow:0 18px 60px rgba(24,38,48,.2)}.ri-data-dialog::backdrop{background:rgba(20,30,35,.28)}.ri-data-form{padding:15px}.ri-data-form h3{margin:0 0 12px;font-size:13px;color:#26343e}.ri-data-form label{display:block;margin:8px 0 4px;font-size:8px;font-weight:750;color:#53616c}.ri-data-form input,.ri-data-form select,.ri-data-form textarea{box-sizing:border-box;width:100%;padding:8px;border:1px solid #d5dde2;border-radius:7px;background:#fff;font-size:9px}.ri-data-form textarea{min-height:64px;resize:vertical}.ri-data-form small{display:block;margin-top:4px;color:#8a969f;font-size:7px;line-height:1.4}.ri-data-form-actions{display:flex;justify-content:flex-end;gap:6px;margin-top:12px}.ri-data-form-actions button{border:1px solid #d5dde2;background:#fff;border-radius:7px;padding:7px 10px;font-size:9px;font-weight:750;cursor:pointer}.ri-data-form-actions .primary{background:#146b55;border-color:#146b55;color:#fff}
