(() => {
  ...
  style.textContent = `
    ...
    .ri-photo-host{display:block}.macro-row > *:not(.ri-photo-host){display:none!important}
  ...
  function ensurePhotoGallery(){
    ...
    const box=document.createElement('div'); box.className='ri-photo-host'; box.innerHTML=`<div class="ri-photo-tools"><strong style="font-size:8px;color:#53616c">Zdjęcia regionu</strong><button type="button" id="ri-photo-add">＋ Dodaj zdjęcie</button></div><div id="ri-photo-gallery" class="ri-photo-gallery"></div>`;
